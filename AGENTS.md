# HAR Edge Deployment Framework — Codex Instructions
...
- Each Codex session works in its own worktree to avoid conflicts
- Use `.Codex/commands/worktree-*.md` commands to manage worktrees

## Agent Routing

Use specialized agents via `.Codex/commands/`:
