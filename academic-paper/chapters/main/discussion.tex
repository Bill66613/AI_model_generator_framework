...
\subsection{Class Imbalance: A Critical but Overlooked Challenge}
...
\subsection{Interactive Preprocessing: A Paradigm Shift}
...
\subsection{Academic HAR Systems}
...
\subsection{Sensor Placement and Orientation}
...
\subsection{Computational Platform Diversity}
...
\subsection{Handcrafted vs Learned Features}
