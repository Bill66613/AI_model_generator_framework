---
description: "Use for code generator modifications, C++ template changes, deployment parity verification, feature extraction formula changes, weight reordering, and scaler parameter updates in deployment/"
tools: [read, edit, search, execute, agent]
model: "Claude Sonnet 4 (copilot)"
argument-hint: "Describe the code generator change needed"
