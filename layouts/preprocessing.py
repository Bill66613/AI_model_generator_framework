...
layout = html.Div([
    # Header Section
    html.Div([
        html.H2("🔬 Signal Preprocessing & Windowing", style={
            'color': '#2E86AB',
            'text-align': 'center',
            'margin-bottom': '10px',
            'font-weight': 'bold'
        }),
        html.P("Clean sensor data and create time windows for Human Activity Recognition", style={
            'text-align': 'center',
            'color': '#666',
            'font-style': 'italic',
            'margin-bottom': '30px'
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.Div([
                    html.Label("Overlap Percentage:", style={
                    ...
                    html.Div(
                        id='overlap-info', style={'margin-top': '10px', 'font-size': '13px', 'color': '#666'})
                ], style={'width': '48%', 'display': 'inline-block', 'vertical-align': 'top'}),

                html.Div([
                    html.Label("Quality Threshold:", style={
                               'font-weight': 'bold', 'margin-bottom': '5px'}),
                    dcc.Slider(
