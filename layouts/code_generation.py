...
layout = html.Div([
    html.Div([
        ...
        html.Div([
            html.Div([
                html.Span("1️⃣ Select Model", style={'margin-right': '20px', 'color': '#28a745'}),
                html.Span("→", style={'margin-right': '20px', 'color': '#ccc'}),
                html.Span("2️⃣ Configure Platform", style={'margin-right': '20px', 'color': '#28a745'}),
                html.Span("→", style={'margin-right': '20px', 'color': '#ccc'}),
                html.Span("3️⃣ Generate Code", style={'margin-right': '20px', 'color': '#28a745'}),
                html.Span("→", style={'margin-right': '20px', 'color': '#ccc'}),
        ...
        html.Div([
            ...
            html.Div([
                html.Div([
                    html.Label("Select Model:", style={'font-weight': 'bold', 'margin-bottom': '8px', 'display': 'block'}),
                    dcc.Dropdown(
        ...
        html.Div([
            ...
            html.Div([
                # Platform selection
                html.Div([
                    html.Label("Target Board:", style={'font-weight': 'bold', 'margin-bottom': '8px', 'display': 'block'}),
                    dcc.RadioItems(
                        ...
                        options=[
                            ...
                            {'label': ' STM32 (ARM Cortex-M)', 'value': 'STM32:stm32:GenF4'},
                        ],
                ...
                html.Div([
                    html.Label("Code Generator:", style={'font-weight': 'bold', 'margin-bottom': '8px', 'display': 'block'}),
                    dcc.Dropdown(
                        ...
                        options=[
                            ...
                            {'label': '⚡ ARM Cortex-M Optimized', 'value': 'arm_cortex'},
                        ],
                    ...
                    html.Div([
                        html.Div("💡 Overlap controls how much windows overlap for real-time classification", style={'margin-bottom': '5px'}),
                        html.Div("• 0% = No overlap (fastest, each window processed once)", style={'margin-bottom': '3px'}),
                        html.Div("• 50% = Half overlap (2x classifications per window)", style={'margin-bottom': '3px'}),
                        html.Div("• 75% = High overlap (4x classifications, smoothest but slowest)", style={'margin-bottom': '5px'}),
                        html.Div("Higher overlap = MORE frequent updates = HIGHER power consumption", style={'font-size': '11px', 'color': '#999'})
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div(id='resource-analysis-output', style={'margin-bottom': '20px'}),
                
                html.Div(id='code-generation-status', style={'margin-bottom': '20px'}),
                
                # Code preview
                html.Div([
                    html.H5("Generated Code Preview:", style={'color': '#495057', 'margin-bottom': '10px'}),
                    html.Div([
                        dcc.Textarea(
                            id='code-preview',
        ...
        html.Div([
            ...
            html.Div([
                ...
                # Progress and output
                html.Div([
                    html.H5("Build Output:", style={'color': '#495057', 'margin-bottom': '10px'}),
                    dcc.Loading(
